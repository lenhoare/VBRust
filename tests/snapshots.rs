...
const TRANSPILE_ONLY: &[&str] =
    &["string_options", "stdlib", "datetime_json", "counter", "greeting", "settings", "fetch", "view_if", "toggle_progress", "radio_choice", "notes", "spacing", "dracula", "converter", "await_fn", "logo", "canvas", "plot", "gui_layout", "showcase", "gui_event_stdlib", "tui_counter", "tui_layout", "tui_list", "tui_panels", "tui_table", "tui_input", "tui_tabs", "tui_dashboard", "tui_chart", "tui_multichart", "tui_fetch", "tui_monitor", "python_scalar", "python_handle", "python_tuple", "dataframe_basics", "dataframe_groupby", "dataframe_join", "web_counter", "web_greeting"];
