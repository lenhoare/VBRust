...
const TRANSPILE_ONLY: &[&str] =
    &["string_options", "stdlib", "json_basics", "datetime_basics", "datetime_json", "http_post", "tui_post", "database", "tui_ideas", "shell", "tui_shell", "counter", "greeting", "settings", "fetch", "view_if", "toggle_progress", "radio_choice", "notes", "spacing", "dracula", "converter", "await_fn", "await_sub", "logo", "canvas", "plot", "gui_layout", "showcase", "gui_event_stdlib", "gui_split", "tui_counter", "tui_layout", "tui_list", "tui_panels", "tui_frame", "tui_table", "tui_input", "tui_memo", "tui_menu", "tui_file", "tui_tabs", "tui_list_tabs", "tui_dashboard", "tui_chart", "tui_multichart", "tui_controls", "tui_fetch", "tui_monitor", "tui_pulse", "tui_life", "tui_nightowl", "tui_jellyfish", "python_scalar", "python_handle", "python_tuple", "dataframe_basics", "dataframe_groupby", "dataframe_join", "web_counter", "web_greeting", "web_settings", "web_fetch", "web_post", "web_dracula", "sketch", "sketch_pulse", "sketch_pixels", "sketch_mandelbrot", "state_types"];
