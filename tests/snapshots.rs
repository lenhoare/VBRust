...
const TRANSPILE_ONLY: &[&str] =
    &["string_options", "stdlib", "datetime_json", "counter", "greeting", "settings", "fetch", "view_if", "toggle_progress", "radio_choice", "notes", "spacing", "dracula", "converter", "await_fn", "logo", "canvas", "plot", "showcase", "tui_counter", "tui_layout", "tui_list", "tui_panels", "tui_table", "tui_input", "tui_tabs", "tui_dashboard", "tui_chart", "tui_fetch", "tui_monitor"];
