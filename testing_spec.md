...
Tests in Vinyl are **executable specifications**. You write the code and the tests;
...
generated Rust, like every other Vinyl error). The process exits non-zero when any
...
is translated back to your descriptions. It also means a Vinyl test *is* a Rust
