//! The Vinyl playground: the whole transpiler (`vbr::compile`) compiled to
//! WebAssembly, wrapped in a two-pane Yew app. Type Vinyl on the left, read the
