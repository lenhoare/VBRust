...
A Turbo Pascal–inspired TUI IDE for Vinyl, built on a reusable terminal code
editor — the “Monaco for TUIs.”

| Crate | Role |
|-------|------|
| **`tide-editor`** | Reusable ratatui editor (document / view / decorations / highlight hooks) |
| **`tide`** | Thin Vinyl IDE shell: blue menus, edit, save, compile-and-run |
...
tide/
  ...
  app/      # tide binary (Vinyl customer)
```
