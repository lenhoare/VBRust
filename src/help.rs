...
pub fn help_manifest() -> Vec<ManifestItem> {
    ...
    vec![
        ...
        item!("split-string", "Split", "String functions", Builtin, "fn/Split"),
        item!("join", "Join", "String functions", Builtin, "fn/Join"),
        item!("space-string", "Space", "String functions", Builtin, "fn/Space"),
        ...
        item!("format", "Format", "Conversion", Builtin, "fn/Format"),
        // Math functions
        ...
        item!("atn", "Atn", "Math functions", Builtin, "fn/Atn"),
...
pub fn build(entries_dir: &Path, out_dir: &Path) -> Result<Report, String> {
    ...
    // — transpile only, same as a Window/Screen/Page/Sketch that cannot pass bare rustc.
